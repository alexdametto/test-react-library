...
function Button(_a) {
    ...
    return jsxRuntimeExports.jsx("button", __assign({ className: "bg-pink-500 p-2 rounded-sm ".concat(className) }, { children: "Hello Button" }));
}

function Text() {
    return jsxRuntimeExports.jsx("p", { children: "Hello Text" });
}
